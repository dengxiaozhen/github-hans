...
I18N.zh = {
    "pubilc": { // 公共区域翻译
        "static": { // 静态翻译
            "Learn Git and GitHub without any code!": "学习 git 和 github 无需任何代码！",
            "Using the Hello World guide, you’ll create a repository, start a branch,": "使用Hello World指南，你将创建一个存储库，启动一个分支，",
            "write comments, and open a pull request.": "写下评论，并发送pull请求。",
            "More code review tools": "更多的代码检查工具",
            "Faster, more flexible code review.": "更快，更灵活的代码审查。",
    ...
    "homepage": { // 未登录首页
        "static": { // 静态翻译
            ...
            "Use at least one letter, one numeral, and seven characters.": "密码最少需要7位，并且包含字母和数字。",
            ...
            "With hundreds of integrations, GitHub is flexible enough to be at the center of your development process.": "Github 足够灵活, 可以搭载在你的开发流程中心。",
            "Who uses GitHub?": "谁在使用GitHub？",
            "Individuals": "个人",
            "Use GitHub to create a personal project, whether you want to experiment with a new programming language or host your life’s work.": "用github创建一个新的私有项目，无论你是否想尝试一下新的编程还是想存放你的日常工作。",
            "Communities": "社区",
            "GitHub hosts one of the largest collections of open source software. Create, manage, and work on some of today’s most influential technologies.": "GitHub 托管了世界上最大的开源软件集合之一, 创建, 管理, 并从事于当今最有有影响力的技术。",
            "Businesses": "企业",
            "Businesses of all sizes use GitHub to support their development process and securely build software.": "各种规模的企业使用的GitHub支持其发展过程中，安全地构建软件。",
            "GitHub is proud to host projects and organizations like": "GitHub自豪地举办项目和组织，如：",
            "Public projects are always free. Private plans start at $7/month.": "公共项目是免费的。私人仓库7美元每月。",
        },
        "regexp": [ // 正则翻译
        ],
    },
